...
st = {
    23: {'fname': 'Dana', 'lname': 'Popescu', 'class': '9b', 'grades': [4, 6, 7]},
    2: {'fname': 'Ion', 'lname': 'Pop', 'class': '10c', 'grades': [8, 5, 9]},
    31: {'fname': 'Gelu', 'lname': 'Ionescu', 'class': '10c', 'grades': [6, 9, 8]},
    15: {'fname': 'Geta', 'lname': 'Ionescu', 'class': '9b', 'grades': [10, 9, 10]},
}
x = list(st.values())
